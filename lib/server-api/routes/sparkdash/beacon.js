			...
			req.Redis.select(2, function() {
				...
				req.Redis.HGET(req.body.clientID, "clientID",function(_err,_exists){
					...
					req.deviceMeta = {
						...
						data: {
							latitude	: (req.body.hasOwnProperty('latitude')) ? req.body.latitude : false,
							longitude	: (req.body.hasOwnProperty('longitude')) ? req.body.longitude : false,
							geohash		: false,
							status		: {}
						}
					}
					...
					if (req.body.data) {
						if (req.body.data.hasOwnProperty('latitude')) {
							req.deviceMeta.data.latitude = req.body.data.latitude;
							delete req.body.data.latitude;
						}
						if (req.body.data.hasOwnProperty('longitude')) {
							req.deviceMeta.data.longitude = req.body.data.longitude;
							delete req.body.data.longitude;
						}	
					}
